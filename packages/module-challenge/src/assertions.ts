...
const RULES: AssertionRule[] = [
  {
    ...
    unit: "activities",
    patterns: [
      /(?:total\s+)?activit(?:y|ies)\s*(?:count)?\s*[:=]?\s*([\d,]+)/gi,
      /([\d,]+)\s+activities\b/gi,
    ],
    parse: numberValue,
    confidence: 0.92,
  },
  {
    ...
    unit: "relationships",
    patterns: [
      /(?:total\s+)?relationships?\s*(?:count)?\s*[:=]?\s*([\d,]+)/gi,
      /([\d,]+)\s+relationships\b/gi,
    ],
    parse: numberValue,
    confidence: 0.9,
  },
  {
    ...
    unit: "activities",
    patterns: [
      /critical\s+activit(?:y|ies)\s*(?:count)?\s*[:=]?\s*([\d,]+)/gi,
      /([\d,]+)\s+critical\s+activities\b/gi,
    ],
    parse: numberValue,
    confidence: 0.92,
  },
  {
    ...
    unit: "activities",
    patterns: [
      /near[- ]critical\s+activit(?:y|ies)\s*(?:count)?\s*[:=]?\s*([\d,]+)/gi,
      /([\d,]+)\s+near[- ]critical\s+activities\b/gi,
    ],
    parse: numberValue,
    confidence: 0.92,
  },
  {
    ...
    unit: "activities",
    patterns: [
      /negative\s+float\s*(?:activities|count)?\s*[:=]?\s*([\d,]+)/gi,
      /([\d,]+)\s+activities\s+with\s+negative\s+float\b/gi,
    ],
    parse: numberValue,
    confidence: 0.9,
  },
  {
    ...
    unit: "%",
    patterns: [
      /(?:overall|actual|project|reported|physical)?\s*progress\s*[:=]?\s*(\d+(?:\.\d+)?)\s*%/gi,
      /progress\s+achieved\s*[:=]?\s*(\d+(?:\.\d+)?)\s*%/gi,
    ],
    parse: numberValue,
    confidence: 0.9,
  },
