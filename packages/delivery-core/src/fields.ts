...
export const deliveryFields:Record<DeliveryKind,string[]>={
 ...
 hse:['exposure scope','incident date','report date','period start','period end','man hours','lost time injuries','frequency rate basis','corrective action','due date','actual date','verification date','closed date','programme consequence'],
