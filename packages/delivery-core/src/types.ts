...
export const emptyLinks=():DeliveryLinks=>({activityIds:[],boqItemIds:[],packageIds:[],supplierIds:[],locationIds:[],assetIds:[],recordIds:[],riskIds:[],claimIds:[],noticeIds:[],variationIds:[],boqAllocations:[]});
