...
function renderMilestonesVisual(data){
  ...
  return '<section class="planning-view milestone-view">'+kpis+basis+
    ...
    '<section class="planning-panel primary"><div class="planning-panel-head"><div><h4>Milestone movement by management priority</h4><p>Highest-priority milestones first. Baseline, current and actual dates remain visible together.</p></div></div><div class="planning-panel-body">'+timeline+'</div></section>'+
