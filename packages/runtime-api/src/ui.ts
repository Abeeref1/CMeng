...
<style>
:root{
  --bg:#f3f5f7;--panel:#ffffff;--ink:#171b22;--muted:#697382;--line:#dfe3e8;
  --accent:#c99737;--accent-strong:#a87319;--accent-soft:#fff8e8;--teal:#0f766e;
  --danger:#b42318;--warn:#9b6417;--ok:#067647;--nav:#080d14;--nav2:#111922;
  --soft:#f7f8fa;--soft-blue:#f8fafc;--shadow:0 1px 2px rgba(15,23,42,.025),0 5px 18px rgba(15,23,42,.04);
  --shadow-strong:0 10px 30px rgba(15,23,42,.06)
}
*{box-sizing:border-box}
html{background:var(--bg)}
body{margin:0;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:var(--bg);color:var(--ink);font-size:15px;line-height:1.48;overflow-x:hidden}
...
.brand-mark{width:46px;height:46px;border-radius:10px;overflow:hidden;background:#fff;border:1px solid #ddd4c2;flex:0 0 auto}.brand-mark img{display:block;width:100%;height:100%;object-fit:cover}
...
.nav-item:hover{background:#f7f6f2;color:#22262c}.nav-item.active{background:#f8f4ea;color:#221d15;box-shadow:inset 2px 0 0 var(--accent)}
...
.empty{padding:34px;text-align:center;color:var(--muted);font-size:14px}.notice{padding:12px 14px;border-radius:9px;font-size:13px;margin:11px 0;line-height:1.45}.notice.info{background:#faf7ef;color:#5c4a2f;border:1px solid #e9deca}.notice.warn{background:#fff9e8;color:#8a4b08;border:1px solid #f8e7b1}.notice.error{background:#fff1f0;color:#912018;border:1px solid #ffd8d3}
...
<div class="app">
  <aside class="sidebar">
    <div class="brand">
      <div class="brand-mark" aria-label="CMeng logo"><img src="data:image/jpeg;base64," alt="CMeng logo"></div>
