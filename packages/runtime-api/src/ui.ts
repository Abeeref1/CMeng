...
.sidebar{background:linear-gradient(180deg,#fbfaf7 0%,#f4f1e9 100%);color:#22252b;padding:20px 14px;position:sticky;top:0;height:100vh;overflow:auto;border-right:1px solid #ded8cb;box-shadow:6px 0 22px rgba(58,48,30,.035)}
.brand{display:flex;align-items:center;gap:12px;padding:17px 7px 16px;border-bottom:1px solid #e3ddcf;margin:-20px 0 14px;position:sticky;top:-20px;z-index:7;background:linear-gradient(180deg,#fbfaf7 0%,#f8f6f0 100%)}
