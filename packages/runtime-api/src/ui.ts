...
.sidebar{background:linear-gradient(180deg,#080d14 0%,#101824 100%);color:#fff;padding:20px 14px;position:sticky;top:0;height:100vh;overflow:auto;border-right:1px solid rgba(255,255,255,.05)}
.brand{display:flex;align-items:center;gap:12px;padding:17px 7px 16px;border-bottom:1px solid rgba(255,255,255,.10);margin:-20px 0 14px;position:sticky;top:-20px;z-index:7;background:linear-gradient(180deg,#080d14 0%,#0d141e 100%)}
.brand-mark{width:52px;height:52px;border-radius:12px;overflow:hidden;background:#05070a;border:1px solid rgba(201,151,55,.45);box-shadow:0 8px 22px rgba(0,0,0,.28);flex:0 0 auto}.brand-mark img{display:block;width:100%;height:100%;object-fit:cover}
...
.nav-item:hover{background:rgba(255,255,255,.055);color:#fff}.nav-item.active{background:rgba(201,151,55,.12);color:#fff;box-shadow:inset 3px 0 0 var(--accent)}
