...
const ALIASES: Record<Exclude<ScheduleColumnRole,"unknown">, string[]> = {
  ...
  start:["start","start date","forecast start","current start","early start","planned start"],
  finish:["finish","finish date","forecast finish","current finish","early finish","planned finish"],
